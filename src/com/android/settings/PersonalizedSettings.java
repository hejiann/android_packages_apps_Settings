...
public class PersonalizedSettings extends PreferenceActivity implements
	...
	private static class HeaderAdapter extends ArrayAdapter<Header> {
		...
		public HeaderAdapter(Context context, List<Header> objects,
			...
			mProfileEnabler = new ProfileEnabler(context, null, new Switch(
					context));
			switcherBean.setmProfileEnabler(mProfileEnabler);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			case HEADER_TYPE_SWITCH:
				...
				// switches
				if (switcherBean.getIsProfile() == 0) {
					mProfileEnabler.setSwitch(holder.switch_);
					switcherBean.setIsProfile(1);
				}
			case HEADER_TYPE_NORMAL:
	...
	public static class InputMethodAndLanguageSettingsActivity extends
			PersonalizedSettings { /* empty */
	}

	public static class KeyboardLayoutPickerActivity extends
			PersonalizedSettings { /* empty */
	}
	...
	public static class SpellCheckersSettingsActivity extends
			PersonalizedSettings { /* empty */
	}
	...
	public static class UserDictionarySettingsActivity extends
			PersonalizedSettings { /* empty */
	}
	...
	public static class ApplicationSettingsActivity extends
			PersonalizedSettings { /* empty */
	}
	...
	public static class DevelopmentSettingsActivity extends
			PersonalizedSettings { /* empty */
	}

	public static class AccessibilitySettingsActivity extends
			PersonalizedSettings { /* empty */
	}
	...
	public static class DockSettingsActivity extends PersonalizedSettings { /* empty */
	}

	public static class RunningServicesActivity extends PersonalizedSettings { /* empty */
	}

	public static class ManageAccountsSettingsActivity extends
			PersonalizedSettings { /* empty */
	}
	...
	public static class AccountSyncSettingsActivity extends
			PersonalizedSettings { /* empty */
	}
	...
	public static class CryptKeeperSettingsActivity extends
			PersonalizedSettings { /* empty */
	}

	public static class DeviceAdminSettingsActivity extends
			PersonalizedSettings { /* empty */
	}
	...
	public static class AdvancedWifiSettingsActivity extends
			PersonalizedSettings { /* empty */
	}

	public static class TextToSpeechSettingsActivity extends
			PersonalizedSettings { /* empty */
	}

	public static class AndroidBeamSettingsActivity extends
			PersonalizedSettings { /* empty */
	}

	public static class AnonymousStatsActivity extends PersonalizedSettings { /* empty */
	}
