...
public class SystemSettings extends PreferenceActivity
    ...
    public boolean shouldUpRecreateTask(Intent targetIntent) {
        return super.shouldUpRecreateTask(new Intent(this, SystemSettings.class));
    }
     ...
     */
    public static class BluetoothSettingsActivity extends SystemSettings { /* empty */ }
    public static class WirelessSettingsActivity extends SystemSettings { /* empty */ }
    public static class TetherSettingsActivity extends SystemSettings { /* empty */ }
    public static class VpnSettingsActivity extends SystemSettings { /* empty */ }
    public static class DateTimeSettingsActivity extends SystemSettings { /* empty */ }
    public static class StorageSettingsActivity extends SystemSettings { /* empty */ }
    public static class WifiSettingsActivity extends SystemSettings { /* empty */ }
    public static class WifiP2pSettingsActivity extends SystemSettings { /* empty */ }
    public static class InputMethodAndLanguageSettingsActivity extends SystemSettings { /* empty */ }
    public static class KeyboardLayoutPickerActivity extends SystemSettings { /* empty */ }
    public static class InputMethodAndSubtypeEnablerActivity extends SystemSettings { /* empty */ }
    public static class SpellCheckersSettingsActivity extends SystemSettings { /* empty */ }
    public static class LocalePickerActivity extends SystemSettings { /* empty */ }
    public static class UserDictionarySettingsActivity extends SystemSettings { /* empty */ }
    public static class SoundSettingsActivity extends SystemSettings { /* empty */ }
    public static class DisplaySettingsActivity extends SystemSettings { /* empty */ }
    public static class DeviceInfoSettingsActivity extends SystemSettings { /* empty */ }
    public static class ApplicationSettingsActivity extends SystemSettings { /* empty */ }
    public static class ManageApplicationsActivity extends SystemSettings { /* empty */ }
    public static class StorageUseActivity extends SystemSettings { /* empty */ }
    public static class DevelopmentSettingsActivity extends SystemSettings { /* empty */ }
    public static class AccessibilitySettingsActivity extends SystemSettings { /* empty */ }
    public static class SecuritySettingsActivity extends SystemSettings { /* empty */ }
    public static class LocationSettingsActivity extends SystemSettings { /* empty */ }
    public static class PrivacySettingsActivity extends SystemSettings { /* empty */ }
    public static class DockSettingsActivity extends SystemSettings { /* empty */ }
    public static class RunningServicesActivity extends SystemSettings { /* empty */ }
    public static class ManageAccountsSettingsActivity extends SystemSettings { /* empty */ }
    public static class PowerUsageSummaryActivity extends SystemSettings { /* empty */ }
    public static class AccountSyncSettingsActivity extends SystemSettings { /* empty */ }
    public static class AccountSyncSettingsInAddAccountActivity extends SystemSettings { /* empty */ }
    public static class CryptKeeperSettingsActivity extends SystemSettings { /* empty */ }
    public static class DeviceAdminSettingsActivity extends SystemSettings { /* empty */ }
    public static class DataUsageSummaryActivity extends SystemSettings { /* empty */ }
    public static class AdvancedWifiSettingsActivity extends SystemSettings { /* empty */ }
    public static class TextToSpeechSettingsActivity extends SystemSettings { /* empty */ }
    public static class AndroidBeamSettingsActivity extends SystemSettings { /* empty */ }
    public static class AnonymousStatsActivity extends SystemSettings { /* empty */ }
    public static class ApnSettingsActivity extends SystemSettings { /* empty */ }
    public static class ApnEditorActivity extends SystemSettings { /* empty */ }
}
