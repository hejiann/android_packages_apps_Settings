...
public class DeviceInfoSettings extends SettingsPreferenceFragment {
	...
	public void onCreate(Bundle icicle) {
		...
		removePreferenceIfPropertyMissing(getPreferenceScreen(),
				KEY_EQUIPMENT_ID, PROPERTY_EQUIPMENT_ID);
		...
		if (preference.getKey().equals(KEY_MOD_VERSION)) {
			...
			if (mHits[0] >= (SystemClock.uptimeMillis() - 500)) {
				...
				intent.setClassName("com.android.settings",
						com.android.settings.cyanogenmod.CIDLogoActivity.class
								.getName());
				try {
					startActivity(intent);
				} catch (Exception e) {
	...
	private String getMemInfo() {
		...
		try {
			/*
			 * /proc/meminfo entries follow this format: MemTotal: 362096 kB
			 * MemFree: 29144 kB Buffers: 5236 kB Cached: 81652 kB
			 */
	...
	private String getCPUInfo() {
		...
		try {
			/*
			 * The expected /proc/cpuinfo output is as follows: Processor :
			 * ARMv7 Processor rev 2 (v7l) BogoMIPS : 272.62
			 */
	...
	private boolean removePreferenceIfPackageNotInstalled(Preference preference) {
		...
		if (packageName != null) {
			try {
				...
				Log.e(LOG_TAG, "package " + packageName
						+ " not installed, hiding preference.");
	...
	public static class LegalInformation extends SettingsPreferenceFragment {
		...
		public void onActivityCreated(Bundle savedInstanceState) {
			...
			/*
			 * Settings is a generic app and should not contain any
			...
			Utils.updatePreferenceToSpecificActivityOrRemove(act,
					...
					Utils.UPDATE_PREFERENCE_FLAG_SET_TITLE_TO_MATCHING_ACTIVITY);
			Utils.updatePreferenceToSpecificActivityOrRemove(act,
					parentPreference, KEY_COPYRIGHT,
					Utils.UPDATE_PREFERENCE_FLAG_SET_TITLE_TO_MATCHING_ACTIVITY);
		}
	}
}
