...
public class PowerWidgetUtil {
    ...
    static {
        ...
        BUTTONS.put(BUTTON_DRIVER, new PowerWidgetUtil.ButtonInfo(
        		BUTTON_DRIVER, R.string.power_widget_order_driver, null));
        ...
        BUTTONS.put(BUTTON_SHUTDOWN, new PowerWidgetUtil.ButtonInfo(
                BUTTON_SHUTDOWN, R.string.title_toggle_shutdown, "com.android.systemui:drawable/stat_shutdown"));
        BUTTONS.put(BUTTON_REBOOT, new PowerWidgetUtil.ButtonInfo(
                BUTTON_REBOOT, R.string.title_toggle_reboot, "com.android.systemui:drawable/stat_reboot"));
    }
