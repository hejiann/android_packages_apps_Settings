...
public class UnlockWithLimitPassword extends PreferenceActivity {
    ...
    private void updateTitle(Intent intent) {
        ...
        try {
            ...
            getActionBar().setTitle(getString(R.string.launcing) + " " + appName);
    ...
    public static class ConfirmLockPasswordFragment extends Fragment implements
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            mContinueButton.setEnabled(false); // disable until the user enters
                                               // at least one char
            ...
            mPasswordEntry
                    .setInputType(isAlpha ? currentType
