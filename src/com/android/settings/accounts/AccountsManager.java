 ...
 */
public class AccountsManager extends PreferenceActivity implements
	...
	public void onBuildHeaders(List<Header> headers) {
		loadHeadersFromResource(R.xml.accounts_manager_settings, headers);
	...
	private void updateHeaderList(List<Header> target) {
		...
		while (i < target.size()) {
			...
			i = insertAccountsHeaders(target, i);
	...
	public boolean shouldUpRecreateTask(Intent targetIntent) {
		return super.shouldUpRecreateTask(new Intent(this, AccountsManager.class));
	}
